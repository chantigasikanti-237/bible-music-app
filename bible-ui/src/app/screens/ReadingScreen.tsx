...
const VERSION_LABELS: Record<number, { label: string; lang: string }> = {
  ...
  1787: { label: 'Telugu OV',           lang: 'te' },
  1683: { label: 'Hindi OV',            lang: 'hi' },
  339:  { label: 'Tamil OV',            lang: 'ta' },
  1693: { label: 'Malayalam OV',        lang: 'ml' },
  1684: { label: 'Kannada JV',          lang: 'kn' },
  1692: { label: 'Kannada CL',          lang: 'kn' },
  1686: { label: 'Marathi RV',          lang: 'mr' },
