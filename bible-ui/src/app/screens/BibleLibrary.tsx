...
export const BIBLE_VERSIONS = [
  ...
  { id: 1787, lang: 'te', label: 'Telugu (తెలుగు)',        sublabel: 'Telugu OV BSI',              flag: '🇮🇳' },
  { id: 1683, lang: 'hi', label: 'Hindi (हिंदी)',          sublabel: 'Hindi OV BSI',               flag: '🇮🇳' },
  { id: 339,  lang: 'ta', label: 'Tamil (தமிழ்)',          sublabel: 'Tamil OV BSI',               flag: '🇮🇳' },
  { id: 1693, lang: 'ml', label: 'Malayalam (മലയാളം)',     sublabel: 'Malayalam OV BSI',           flag: '🇮🇳' },
  { id: 1684, lang: 'kn', label: 'Kannada (ಕನ್ನಡ)',        sublabel: 'Kannada JV BSI',             flag: '🇮🇳' },
  { id: 1692, lang: 'kn', label: 'Kannada CL (ಕನ್ನಡ)',    sublabel: 'Kannada CL BSI',             flag: '🇮🇳' },
  { id: 1686, lang: 'mr', label: 'Marathi (मराठी)',        sublabel: 'Marathi RV BSI',             flag: '🇮🇳' },
